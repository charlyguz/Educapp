<template>
  <navbar
    ...
    name1="Comunidad"
    link2="/estudiantes/agenda"
    name2="Agenda"
    link3="/estudiantes"
    link4="/estudiantes/progreso"
    name4="Progreso"
    link5="/estudiantes/cursos"
    name5="Mis Cursos"
  ></navbar>
  <div
    class="section__index-container container flex-wrap flex-md-nowrap m-auto"
  >
    <div class="w-100 justify-start">
      <h5 class="global-title notificationText">
        Hola Juan {{ notificationText }}
      </h5>
      <div class="notification-box">
        <notification
          title="Tutoria"
          :time="timeUpdated"
          msg="Tienes una tutoria para hoy"
        ></notification>
      </div>
    </div>
    <section class="">
    ...
    <section class="mis_cursos w-100">
      ...
      <div class="section__comunidad-container-grid">
        <curso
          img="/imgs/biologia.jpg"
          title="Fundamentos de biología"
          description="Describir la organización de los seres vivos en general y del ser humano"
          color="#6cb17d"
        ></curso>
        ...
        <curso
          img="/imgs/ciencias.jpg"
          title="Partes de un cuento"
          description="Los cuentos entretienen, aportan valores y ayudan al desarrollo de las emociones"
          color="#8ccee6"
        ></curso>
      </div>
    </section>
...
export default {
  ...
  mounted() {
    setTimeout(() => {
      ...
      this.timeUpdated = document.getElementsByClassName(
        'time-change'
      ).innerText = datetime
    }, 3000)
  },
  ...
  methods: {
    ...
    nivelBadge(nivel) {
      ...
      let nombreNivel = this.niveles.find(
        (nivel) => nivel.nivel === nivelExaacto
      ).nombre
...
@keyframes neon {
  ...
  50% {
    text-shadow: 0 0 5px rgb(255, 30, 0), 0 0 10px rgb(255, 0, 0),
      0 0 20px rgb(255, 34, 0), 0 0 40px rgb(127, 50, 38),
      0 0 80px rgb(127, 38, 38), 0 0 90px rgb(127, 38, 38),
      0 0 100px rgb(127, 47, 38), 0 0 140px rgb(127, 48, 38),
      0 0 180px rgb(127, 50, 38);
  }
  100% {
    text-shadow: 0 0 5px rgb(9, 255, 0), 0 0 10px rgb(21, 255, 0),
      0 0 20px rgb(0, 255, 21), 0 0 40px rgb(38, 127, 44),
      0 0 80px rgb(38, 127, 42), 0 0 90px rgb(38, 127, 44),
      0 0 100px rgb(38, 127, 42), 0 0 140px rgba(38, 104, 127, 1),
      0 0 180px rgba(38, 104, 127, 1);
  }
}
.neon:hover {
