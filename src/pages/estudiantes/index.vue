<template>
  ...
  <!-- notificaciones -->
  <div class="notifications-container px-4 w-100 my-4 d-flex justify-start">
    <h4>Notificaciones: <span @click="toggleNotification" class="icon-notifications"><img src="../../assets/icons/arrow.png" alt=""></span> </h4>
